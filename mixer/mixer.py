...
Example pipeline:
gst-launch-1.0 mixer name=m ! videoconvert ! autovideosink \
        videotestsrc ! m. \
        videotestsrc pattern=ball ! m. \
        videotestsrc pattern=snow ! m.
'''
...
class Videomixer(GstBase.Aggregator):
    ...
    def mix_buffers(self, agg, pad, bdata):
        ...
        img = Image.frombuffer('RGBA', (320, 240), info.data,
                               "raw", 'RGBA', 0, 1)
...
__gstelementfactory__ = ("mixer", Gst.Rank.NONE, Videomixer)
